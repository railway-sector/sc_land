import{ar as o,i3 as pe,aC as T,pk as ue,xP as fe,pi as ge,m2 as _e,bj as X,jO as Z,LU as me,LR as Pe,Mn as ve,JZ as f,L7 as w,LW as be,J_ as z,JX as r,fX as U,Au as Q,LT as we,KR as S,bk as $,fq as N,Mo as Ve,az as Y,L5 as ee,Kw as C,xN as xe,kd as m,aI as P,Mp as te,aw as De,gM as ie,kH as Ee,jZ as Le,kQ as ye,bl as Se,i0 as ne,aq as se,kF as Ce,xK as Me,J$ as ae,K0 as re,a3 as le,L_ as Ae,JP as $e,aE as W,kR as q,LS as Re,Ay as Te,Ku as Oe,Lf as qe,JW as F,e4 as Ue,Mq as Ie,a5 as u,Ke as x,L$ as je,M0 as H,Mr as ze,gJ as Ne,Ms as R,Mt as We,kL as Fe,z5 as He,kN as Be,kO as ke,kP as Ge,kS as Je,x as M,y as Ke,Mu as Xe,dZ as B}from"./index-aRi8Xk-b.js";import{t as Ze}from"./VisualElement-CFrfzfzY.js";let k=class{constructor(e){this._renderCoordsHelper=e,this._origin=o(),this._dirty=!1,this._count=0}set vertices(e){const n=pe(3*e.length);let i=0;for(const s of e)n[i++]=s[0],n[i++]=s[1],n[i++]=s[2];this.buffers=[n]}set buffers(e){if(this._buffers=e,this._buffers.length>0){const n=this._buffers[0],i=3*Math.floor(n.length/3/2);T(this._origin,n[i],n[i+1],n[i+2])}else T(this._origin,0,0,0);this._dirty=!0}get origin(){return this._origin}draw(e){const n=this._ensureVAO(e);n!=null&&(e.bindVAO(n),e.drawArrays(ue.TRIANGLES,0,this._count))}dispose(){this._vao!=null&&this._vao.dispose()}get _layout(){return this._renderCoordsHelper.viewingMode===1?Ye:et}_ensureVAO(e){return this._buffers==null?null:(this._vao??=this._createVAO(e,this._buffers),this._ensureVertexData(this._vao,this._buffers),this._vao)}_createVAO(e,n){const i=this._createDataBuffer(n);return this._dirty=!1,new fe(e,new ge(e,_e(this._layout),i))}_ensureVertexData(e,n){if(!this._dirty)return;const i=this._createDataBuffer(n);e.buffer()?.setData(i),this._dirty=!1}_createDataBuffer(e){const n=e.reduce((g,c)=>g+G(c),0);this._count=n;const i=this._layout.createBuffer(n),s=this._origin;let a=0,l=0;const d="startUp"in i?this._setUpVectors.bind(this,i):void 0;for(const g of e){for(let c=0;c<g.length;c+=3){const y=T(J,g[c],g[c+1],g[c+2]);c===0?l=this._renderCoordsHelper.getAltitude(y):this._renderCoordsHelper.setAltitude(y,l);const _=a+2*c;d?.(c,_,g,y);const j=X(J,y,s);if(c<g.length-3){for(let v=0;v<6;v++)i.start.setVec(_+v,j);i.extrude.setValues(_,0,-1),i.extrude.setValues(_+1,1,-1),i.extrude.setValues(_+2,1,1),i.extrude.setValues(_+3,0,-1),i.extrude.setValues(_+4,1,1),i.extrude.setValues(_+5,0,1)}if(c>0)for(let v=-6;v<0;v++)i.end.setVec(_+v,j)}a+=G(g)}return i.buffer}_setUpVectors(e,n,i,s,a){const l=this._renderCoordsHelper.worldUpAtPosition(a,Qe);if(n<s.length-3)for(let d=0;d<6;d++)e.startUp.setVec(i+d,l);if(n>0)for(let d=-6;d<0;d++)e.endUp.setVec(i+d,l)}};function G(t){return 3*(2*(t.length/3-1))}const Qe=o(),J=o(),Ye=Z().vec3f("start").vec3f("end").vec2f("extrude").vec3f("startUp").vec3f("endUp"),et=Z().vec3f("start").vec3f("end").vec2f("extrude");function oe(t,e){const n=t.fragment;n.include(me),t.include(Pe),n.include(ve),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new be("depthMap",i=>i.depth?.attachment),new z("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function A(t){return ie(at,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-U(2))))}function tt(t,e){const n=m(ot,t.pointDistanceOrigin,e.camera.viewMatrix),i=Y(t.pointDistanceOrigin,t.pointDistanceTarget);return Le(ct,n,i)}function it(t,e){const n=ye(t.lineVerticalPlaneSegment,.5,p),i=t.renderCoordsHelper.worldUpAtPosition(n,rt),s=$(V,t.lineVerticalPlaneSegment.vector),a=Se(p,i,s);return $(a,a),he(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function nt(t,e){const n=P(p,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function st(t,e){const n=ne(p,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function he(t,e,n){return m(K,t,n),P(h,e),h[3]=0,te(h,h,n),Ee(K,h,lt)}const at=se(),p=o(),h=De(),rt=o(),V=o(),K=o(),lt=Ce(),ot=o(),ct=Me(),ht=Object.freeze(Object.defineProperty({__proto__:null,build:ce,defaultAngleCutoff:I},Symbol.toStringTag,{value:"Module"}));class dt extends $e{constructor(){super(...arguments),this.innerColor=W(1,1,1),this.innerWidth=1,this.glowColor=W(1,.5,0),this.glowWidth=8,this.glowFalloff=8,this.globalAlpha=.75,this.globalAlphaContrastBoost=2,this.angleCutoff=U(6),this.pointDistanceOrigin=o(),this.pointDistanceTarget=o(),this.lineVerticalPlaneSegment=q(),this.intersectsLineSegment=q(),this.intersectsLineRadius=3,this.heightManifoldTarget=o(),this.lineStartWorld=o(),this.lineEndWorld=o()}}class pt extends ae{constructor(e,n){super(e,n,new re(ht,()=>le(()=>Promise.resolve().then(()=>vt),void 0)),Ae)}}function de(t){const e=new Q;e.include(oe,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Re("modelView",(a,{camera:l})=>Te(ft,l.viewMatrix,a.origin)),new Oe("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new qe("pixelToNDC",({camera:a})=>ie(ut,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
