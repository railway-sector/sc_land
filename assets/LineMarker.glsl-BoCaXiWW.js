import{As as Z,Lb as X,Lc as ee,JQ as te,JO as ie,Ld as re,Le as ae,JV as o,L4 as se,Ks as oe,L3 as ne,JU as w,Lf as ce,Lg as le,JR as pe,JT as de,JW as he,KP as ve,JY as ue,Lh as K,Li as N,Lj as me,Lk as fe,Kw as ge,jJ as Se,JZ as Pe,J_ as ye,_ as _e,J$ as C,K0 as R,K1 as we,K2 as E,K3 as M,Ky as ze,K5 as xe,K6 as $e,K7 as be,K9 as L,Ka as Te,Ll as Le,Lm as U,Ln as J,Lo as Ve,Lp as ke,Lq as Oe,Kb as De,Z as p,Kc as d,jG as We,Kz as Ce,Lr as I,u$ as Me,KX as je,pk as Ae,Kh as Fe,ax as B,aE as Ke,k8 as q,am as Y,Ls as Ne}from"./index-Bp3GeDhQ.js";function G(r){const e=new Z,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(X,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)),ce(a),e.include(le),a.main.add(o`
    ...
    }`),S.include(pe,r),e.include(de,r),S.include(he),S.uniforms.add(new ve("intrinsicColor",({color:l})=>l),new ue("tex",({markerTexture:l})=>l)).constants.add("texelSize","float",1/K).code.add(o`float markerAlpha(vec2 samplePos) {
samplePos += vec2(0.5, -0.5) * texelSize;
float sdf = texture(tex, samplePos).r;
float pixelDistance = sdf * vSize;
pixelDistance -= 0.5;
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),P&&(e.include(N),S.constants.add("relativeMarkerSize","float",me/K).constants.add("relativeTipLineWidth","float",fe).code.add(o`
  ...
  `)),e.include(ge,r),e.include(N),S.main.add(o`
    ...
    outputColorHighlightOID(finalColor, vpos, finalColor.rgb);`),e}const Re=Object.freeze(Object.defineProperty({__proto__:null,build:G},Symbol.toStringTag,{value:"Module"}));let Ee=class extends Pe{constructor(e,i){super(e,i,new ye(Re,()=>_e(()=>Promise.resolve().then(()=>Ye),void 0)),H(i).locations)}_makePipelineState(e,i){const{output:t,oitPass:P,space:z,hasOccludees:u}=e;return C({blending:L(t)?Te(P):null,depthTest:z===0?null:{func:be(P)},depthWrite:$e(e),drawBuffers:ze(t,xe(P,t)),colorWrite:M,stencilWrite:u?E:null,stencilTest:u?i?R:we:null,polygonOffset:{factor:0,units:-10}})}initializePipeline(e){return e.occluder?(this._occluderPipelineTransparent=C({blending:J,depthTest:U,depthWrite:null,colorWrite:M,stencilWrite:null,stencilTest:Le}),this._occluderPipelineOpaque=C({blending:J,depthTest:U,depthWrite:null,colorWrite:M,stencilWrite:ke,stencilTest:Ve}),this._occluderPipelineMaskWrite=C({blending:null,depthTest:Oe,depthWrite:null,colorWrite:null,stencilWrite:E,stencilTest:R})):this._occluderPipelineTransparent=this._occluderPipelineOpaque=this._occluderPipelineMaskWrite=null,this._occludeePipelineState=this._makePipelineState(e,!0),this._makePipelineState(e,!1)}getPipeline(e,i){return e?this._occludeePipelineState:i===11?this._occluderPipelineTransparent??super.getPipeline():i===10?this._occluderPipelineOpaque??super.getPipeline():this._occluderPipelineMaskWrite??super.getPipeline()}};function H(r){const e=Se().vec3f("position").vec4f16("previousDelta").vec2f16("uv0");return r.hasVVColor?e.f32("colorFeatureAttribute"):e.vec4u8("color",{glNormalized:!0}),r.hasVVOpacity&&e.f32("opacityFeatureAttribute"),r.hasVVSize?e.f32("sizeFeatureAttribute"):e.f16("size"),r.worldSpace&&e.vec3f16("normal"),e.freeze()}class c extends De{constructor(e){super(),this.spherical=e,this.space=1,this.anchor=0,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.hasVVSize=!1,this.hasVVColor=!1,this.hasVVOpacity=!1,this.hasOccludees=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.hasScreenSizePerspective=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasSliceTranslatedView=!0,this.olidColorInstanced=!1,this.overlayEnabled=!1,this.snowCover=!1}get draped(){return this.space===0}get worldSpace(){return this.space===2}}p([d({count:3})],c.prototype,"space",void 0),p([d({count:2})],c.prototype,"anchor",void 0),p([d()],c.prototype,"occluder",void 0),p([d()],c.prototype,"writeDepth",void 0),p([d()],c.prototype,"hideOnShortSegments",void 0),p([d()],c.prototype,"hasCap",void 0),p([d()],c.prototype,"hasTip",void 0),p([d()],c.prototype,"hasVVSize",void 0),p([d()],c.prototype,"hasVVColor",void 0),p([d()],c.prototype,"hasVVOpacity",void 0),p([d()],c.prototype,"hasOccludees",void 0),p([d()],c.prototype,"terrainDepthTest",void 0),p([d()],c.prototype,"cullAboveTerrain",void 0),p([d()],c.prototype,"hasScreenSizePerspective",void 0);class Qe extends We{constructor(e,i){super(e,Je),this.produces=new Map([[2,t=>t===9||L(t)&&this.parameters.renderOccluded===8],[3,t=>Ce(t)],[10,t=>I(t)&&this.parameters.renderOccluded===8],[11,t=>I(t)&&this.parameters.renderOccluded===8],[4,t=>L(t)&&this.parameters.writeDepth],[8,t=>L(t)&&!this.parameters.writeDepth],[18,t=>L(t)||t===9]]),this.intersectDraped=void 0,this._configuration=new c(i)}getConfiguration(e,i){return super.getConfiguration(e,i,this._configuration),this._configuration.space=i.slot===18?0:this.parameters.worldSpace?2:1,this._configuration.hideOnShortSegments=this.parameters.hideOnShortSegments,this._configuration.hasCap=this.parameters.cap!==0,this._configuration.anchor=this.parameters.anchor,this._configuration.hasTip=this.parameters.hasTip,this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.hasOccludees=i.hasOccludees,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.hasVVSize=this.parameters.hasVVSize,this._configuration.hasVVColor=this.parameters.hasVVColor,this._configuration.hasVVOpacity=this.parameters.hasVVOpacity,this._configuration.occluder=this.parameters.renderOccluded===8,this._configuration.oitPass=i.oitPass,this._configuration.terrainDepthTest=i.terrainDepthTest&&L(e),this._configuration.cullAboveTerrain=i.cullAboveTerrain,this._configuration.hasScreenSizePerspective=this.parameters.screenSizePerspective!=null,this._configuration}get visible(){return this.parameters.color[3]>=Me}intersect(){}createBufferWriter(){return new Ie(H(this.parameters),this.parameters)}createGLMaterial(e){return new Ue(e)}}class Ue extends Fe{dispose(){super.dispose(),this._markerTextures?.release(this._markerPrimitive),this._markerPrimitive=null}beginSlot(e){const i=this._material.parameters.markerPrimitive;return i!==this._markerPrimitive&&(this._material.setParameters({markerTexture:this._markerTextures.swap(i,this._markerPrimitive)}),this._markerPrimitive=i),this.getTechnique(Ee,e)}}class Je extends je{constructor(){super(...arguments),this.width=0,this.color=[1,1,1,1],this.markerPrimitive="arrow",this.placement="end",this.cap=0,this.anchor=0,this.hasTip=!1,this.worldSpace=!1,this.hideOnShortSegments=!1,this.writeDepth=!0,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.stipplePattern=null,this.markerTexture=null}}class Ie{constructor(e,i){this.layout=e,this._parameters=i}elementCount(){return this._parameters.placement==="begin-end"?12:6}write(e,i,t,P,z,u){const g=t.get("position").data,a=g.length/3;let S=[1,0,0];const y=t.get("normal");this._parameters.worldSpace&&y!=null&&(S=y.data);let h=1,l=0;this._parameters.vvSize?l=t.get("sizeFeatureAttribute").data[0]:t.has("size")&&(h=t.get("size").data[0]);let $=[1,1,1,1],j=0;this._parameters.vvColor?j=t.get("colorFeatureAttribute").data[0]:t.has("color")&&($=t.get("color").data);let A=0;this._parameters.vvOpacity&&(A=t.get("opacityFeatureAttribute").data[0]);const x=new Float32Array(z.buffer),_=Ae(z.buffer),V=new Uint8Array(z.buffer);let v=u*(this.layout.stride/4);const b=x.BYTES_PER_ELEMENT/_.BYTES_PER_ELEMENT,Q=4/b,T=(n,O,m,f)=>{x[v++]=n[0],x[v++]=n[1],x[v++]=n[2],Ne(O,n,_,v*b),v+=Q;let s=v*b;if(_[s++]=m[0],_[s++]=m[1],v=Math.ceil(s/b),this._parameters.vvColor)x[v++]=j;else{const D=Math.min(4*f,$.length-4),W=4*v++;V[W]=255*$[D],V[W+1]=255*$[D+1],V[W+2]=255*$[D+2],V[W+3]=255*$[D+3]}this._parameters.vvOpacity&&(x[v++]=A),s=v*b,this._parameters.vvSize?(x[v++]=l,s+=2):_[s++]=h,this._parameters.worldSpace&&(_[s++]=S[0],_[s++]=S[1],_[s++]=S[2]),v=Math.ceil(s/b)},F=(n,O)=>{const m=B(Be,g[3*n],g[3*n+1],g[3*n+2]),f=qe;let s=n+O;do B(f,g[3*s],g[3*s+1],g[3*s+2]),s+=O;while(Ke(m,f)&&s>=0&&s<a);e&&(q(m,m,e),q(f,f,e)),T(m,f,[-1,-1],n),T(m,f,[1,-1],n),T(m,f,[1,1],n),T(m,f,[-1,-1],n),T(m,f,[1,1],n),T(m,f,[-1,1],n)},k=this._parameters.placement;return k!=="begin"&&k!=="begin-end"||F(0,1),k!=="end"&&k!=="begin-end"||F(a-1,-1),null}}const Be=Y(),qe=Y(),Ye=Object.freeze(Object.defineProperty({__proto__:null,build:G},Symbol.toStringTag,{value:"Module"}));export{Qe as g};
