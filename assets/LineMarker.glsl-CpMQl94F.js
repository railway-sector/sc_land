import{Ac as X,Jv as Z,Jw as ee,I9 as te,I7 as ie,Jx as re,Jy as ae,Ie as o,Jo as se,IN as oe,Jn as ne,Id as w,Jz as ce,JA as le,Ia as pe,Ic as de,If as he,J7 as ve,Ih as ue,JB as J,JC as F,JD as me,JE as fe,IR as ge,jR as Se,Ii as Pe,Ij as ye,U as _e,Ik as I,Il as N,Im as we,In as R,Io as M,IT as ze,Iq as xe,Ir as $e,Is as Te,Iu as V,Iv as be,JF as Ve,JG as U,JH as E,JI as ke,JJ as Oe,JK as De,Iw as Ce,_ as p,Ix as d,jO as We,IU as Ie,JL as B,uz as Me,Jf as Le,p_ as je,IC as Ae,aC as q,aJ as Je,kg as H,ar as G,JM as Fe}from"./index-BrQW8HOS.js";function Y(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)),ce(a),e.include(le),a.main.add(o`
    ...
    }`),S.include(pe,r),e.include(de,r),S.include(he),S.uniforms.add(new ve("intrinsicColor",({color:l})=>l),new ue("tex",({markerTexture:l})=>l)).constants.add("texelSize","float",1/J).code.add(o`float markerAlpha(vec2 samplePos) {
samplePos += vec2(0.5, -0.5) * texelSize;
float sdf = texture(tex, samplePos).r;
float pixelDistance = sdf * vSize;
pixelDistance -= 0.5;
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),P&&(e.include(F),S.constants.add("relativeMarkerSize","float",me/J).constants.add("relativeTipLineWidth","float",fe).code.add(o`
