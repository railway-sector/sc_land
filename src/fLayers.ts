...
const LabelClass = await $arcgis.import(
...
const {
  ...
  LineSymbol3D,
  PathSymbol3DLayer,
} = await $arcgis.import("@arcgis/core/symbols");
const SolidEdges3D = await $arcgis.import(
  "@arcgis/core/symbols/edges/SolidEdges3D",
);
